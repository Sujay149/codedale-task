  ...
  return (
    <footer className="bg-gray text-black pt-16 pb-8 relative overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
        <span className="text-[15rem] font-bold text-black/[0.03] tracking-wider blackspace-nowrap">CodeDale</span>
      </div>
      ...
      <div className="relative mx-auto max-w-[1200px] px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-black">CodeDale</span>
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-black/10">
          <p className="text-sm text-black/40">&copy;2025 CodeDale All rights reserved</p>
        </div>
      </div>
    </footer>
  )
